...
// Polygon Coordinates 
  ...
  for (var polygon of polygons) {
      polygon.addListener('click', function(){
          ...
          tomtebox = $("#tomtebox");
          tomtebox.html("<h3>Tomt: " + this.metadata.id + " </h3><p>Pris: " + this.metadata.pris + " </p><p>Gårdsnr.: " + this.metadata.gnr + " </p><p>Areal: " + this.metadata.areal + "<p>Merknad: " + this.metadata.tekst + "</p>");
